                ...
                <div class="draw-detail">
                    ...
                    @if(empty($value->address['address']))
                        <div class="award-address">
                            <a href="{{route('LuckyDraw02::addAddress',['token'=>$configure['token'],'l_id'=>$id,'id'=>$value['id']])}}"><span
                                        class="code-title" style="float: right; width:120px;">快递信息填写</span></a>
                        </div>
                    @else
                        <div class="award-address">
                            <span class="code-title"
                                  style="float: right; width:120px;">{{$value->address['address']}}</span>
                        </div>
                    @endif
                </div>
            </li>
