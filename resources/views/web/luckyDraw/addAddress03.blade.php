...
<div id="container">
    <div class="page_topbar">
        <a href="{{route('LuckyDraw03::myRecord',['token'=>$data['token'],'l_id'=>$data['l_id']])}}" class="back">
...
<script>
    const saveAddressUrl = '<?php echo route('LuckyDraw03::saveAddress'); ?>';
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status == true) {
                    ...
                    window.location.href = '/webWechat/luckyDraw/myRecord03?token={{$data['token']}}&l_id={{$data['l_id']}}';
                }
            },
            error: function (e) {
                alert('服务繁忙,请稍后再试！')
