...
<div id="container">
    <div class="page_topbar">
        <a href="{{route('LuckyDraw01::myRecord',['token'=>$data['token'],'l_id'=>$data['l_id']])}}" class="back">
    ...
    <div id="container">
        ...
        {{--        <div class="address_sub2" onclick="reset()">取消</div>--}}
    </div>
    <br>
...
<script>
    const saveAddressUrl = '<?php echo route('LuckyDraw01::saveAddress'); ?>';
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status == true) {
                    ...
                    window.location.href = '/webWechat/luckyDraw/myRecord01?token={{$data['token']}}&l_id={{$data['l_id']}}';
                }
            },
            error: function (e) {
                alert('服务繁忙,请稍后再试！')
