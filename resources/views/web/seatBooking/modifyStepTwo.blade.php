...
<!--<style></style>-->
<div class="btBtnArea">
    <div class="stepTowPev failure">上一步</div>
...
<script type="text/javascript">
    ...
    const minStatus="{{$chartData->region->s_time}}";
    const maxStatus="{{$chartData->region->e_time}}";
    ...
    $(document).on('tap', '.nextUrl', function(){
        ...
        location.href="{!! route('Seat::modifyStepTree', ['token'=>request()->input('token'),'bookingId'=>request()->input('bookingId')])!!}"+'&stime='+Stime+'&etime='+Etime;
    });
