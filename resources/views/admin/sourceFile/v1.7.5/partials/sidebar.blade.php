        ...
        <div class="user-panel">
            ...
            <!-- Status -->
                @if(request()->session()->get('wxtoken'))
                    <a><i class="fa fa-wechat text-success"></i> {{ request()->session()->get('wxname') }}</a>
                    <br>
                    <a><i class="fa fa-check-square-o text-success"></i> {{ request()->session()->get('wxtoken') }}</a>
                @else
                    <a><i class="fa fa-circle text-success"></i> {{ trans('admin.online') }}</a>
                @endif
            </div>
        </div>
