<link rel="stylesheet" href="{{admin_asset('/wechatAdmin/customMenu/css/cu_base.css')}}"/>
<link rel="stylesheet" href="{{admin_asset('/wechatAdmin/customMenu/css/cu_index.css')}}"/>
{{--<link rel="stylesheet" href="{{admin_asset('/wechatAdmin/customMenu/css/cu_lib.css')}}" />--}}
<link rel="stylesheet" href="{{admin_asset('/wechatAdmin/customMenu/css/cu_all.css')}}"/>

<div class="menu_setting_box js_menuBox dn" style="display: block;">
    <textarea id="result"
              style="border: none;position: absolute;width: 315px;height: 462px;left: 41px;top: 132px;z-index: 2;word-break: break-all;"></textarea>
    <div class="menu_setting_area js_editBox">
        <div class="menu_preview_area">
            <div class="mobile_menu_preview">
                ...
                <div class="mobile_bd">
                    <ul class="pre_menu_list grid_line ui-sortable ui-sortable-disabled no_menu" style="z-index:3;"
                        id="menuList">
                        <li v-for="(btn,index) in menu.button" :key="btn.id"
                            ...
                            <a href="javascript:void(0);" @click="menu_selected(btn.name,index)"
                            ...
                            <div class="sub_pre_menu_box js_l2TitleBox" v-if="index===activeMenuIndex">
                                <ul class="sub_pre_menu_list">
                                    <li v-for="(sub,index) in btn.sub_button" :key="sub.id" class='jslevel2'><a
                                                href="javascript:void(0);" @click="menu_item_selected(sub.name,index)"
                                                :class="[{pre_menu_link: index===activeMenuItemIndex && activeMenuType()==2}]"
                                                class="jsSubView" draggable="false"><span
                                                    class="sub_pre_menu_inner js_sub_pre_menu_inner"><i
                                                        class="icon20_common sort_gray"></i><span class='js_l2Title'>@{{ sub.name }}</span></span></a>
                                    </li>
                                    <li class='js_addMenuBox'
                                        ...
                                        <a href="javascript:void(0);" class="jsSubView js_addL2Btn" title="最多添加5个子菜单"
                                           @click="menu_item_add()" draggable="false"><span
                                                    class="sub_pre_menu_inner js_sub_pre_menu_inner"><i
                        ...
                        <li class="js_addMenuBox pre_menu_item grid_item no_extra size1of1"><a
                                    ...
                                    @click="menu_add()" :class="[{pre_menu_link: activeMenuIndex===''}]"
                                    class="js_addL1Btn" title="最多添加3个一级菜单" draggable="false"> <i
                                        class="icon14_menu_add"></i> <span class="js_addMenuTips">添加菜单</span></a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="editor_inner">
                    <div class="global_mod float_layout menu_form_hd js_second_title_bar">
                        ...
                        <div class="global_extra">
                            ...
                            <a href="javascript:void(0);" id="jsDelBt" @click="menu_item_del()"
                    ...
                    <div class="menu_form_bd" id="view">
                        ...
                        <div class="frm_control_group js_setNameBox">
                            ...
                            <div class="frm_controls">
                                <span class="frm_input_box with_counter counter_in append"
                                      v-if="activeMenuType() == 1 && isSet(menu.button[activeMenuIndex])"> <input
                                            type="text" class="frm_input js_menu_name"
                                            v-model="menu.button[activeMenuIndex].name"/> </span>
                                <span class="frm_input_box with_counter counter_in append"
                                      v-if="activeMenuType() == 2 && isSet(menu.button[activeMenuIndex].sub_button[activeMenuItemIndex])"> <input
                                            type="text" class="frm_input js_menu_name"
                                            v-model="menu.button[activeMenuIndex].sub_button[activeMenuItemIndex].name"/> </span>
                        ...
                        <div class="frm_control_group"
                            ...
                            <div class="frm_controls frm_vertical_pt">
                                <label class="frm_radio_label js_radio_sendMsg" @click="radio_label_selected(1)"
                                       :class="[{selected:showMenuContentType===1}]" data-editing="0"> <i
                                            class="icon_radio"></i> <span class="lbl_content">发送消息</span> <input
                                            type="radio" name="hello" class="frm_radio"/> </label>
                                <label class="frm_radio_label js_radio_url" @click="radio_label_selected(2)"
                                       :class="[{selected:showMenuContentType===2}]" data-editing="0"> <i
                                            class="icon_radio"></i> <span class="lbl_content">跳转网页</span> <input
                                            type="radio" name="hello" class="frm_radio"/> </label>
                                <label class="frm_radio_label js_radio_url" @click="radio_label_selected(3)"
                                       :class="[{selected:showMenuContentType===3}]" data-editing="0"> <i
                                            class="icon_radio"></i> <span class="lbl_content">扫码</span> <input
                                            type="radio" name="hello" class="frm_radio"/> </label>
                                <label class="frm_radio_label js_radio_url" @click="radio_label_selected(4)"
                                       :class="[{selected:showMenuContentType===4}]" data-editing="0"> <i
                                            class="icon_radio"></i> <span class="lbl_content">小程序</span> <input
                                            type="radio" name="hello" class="frm_radio"/> </label>
                            </div>
                        </div>
                        <div class="menu_content_container">
                            <div class="menu_content send jsMain" id="edit" v-show="showMenuContentType===1"
                                 style="display: none;">
                                <div class="msg_sender" id="editDiv">
                                    <div class="msg_tab">
                                        <div class="tab_navs_panel">
                                            <span class="tab_navs_switch_wrp switch_prev js_switch_prev"> <span
                                                        class="tab_navs_switch"></span> </span>
                                            <span class="tab_navs_switch_wrp switch_next js_switch_next"
                                                  style="display: none;"> <span class="tab_navs_switch"></span> </span>
                                            <div class="tab_navs_wrp" style="width: 650px">
                                                <ul class="tab_navs js_tab_navs" style="margin-left:0;">
                                                    <li class="tab_nav tab_appmsg width4"
                                                        :class="[{selected:showMenuContentMsgType===1}]" data-type="10"
                                                        data-tab=".js_appmsgArea" data-tooltip="图文消息"><a
                                                                href="javascript:void(0);"
                                                                @click="content_msg_tab_nav(1)">&nbsp;<i
                                                                    class="icon_msg_sender"></i><span
                                                                    class="msg_tab_title">图文消息</span></a></li>
                                                    <li class="tab_nav tab_img width4"
                                                        :class="[{selected:showMenuContentMsgType===2}]" data-type="2"
                                                        data-tab=".js_imgArea" data-tooltip="图片"><a
                                                                href="javascript:void(0);"
                                                                @click="content_msg_tab_nav(2)">&nbsp;<i
                                                                    class="icon_msg_sender"></i><span
                                                                    class="msg_tab_title">图片</span></a></li>
                                                    <li class="tab_nav tab_audio width4"
                                                        :class="[{selected:showMenuContentMsgType===3}]" data-type="3"
                                                        data-tab=".js_audioArea" data-tooltip="语音"><a
                                                                href="javascript:void(0);"
                                                                @click="content_msg_tab_nav(3)">&nbsp;<i
                                                                    class="icon_msg_sender"></i><span
                                                                    class="msg_tab_title">语音</span></a></li>
                                                    <li class="tab_nav tab_video width4 no_extra"
                                                        :class="[{selected:showMenuContentMsgType===4}]" data-type="15"
                                                        data-tab=".js_videoArea" data-tooltip="视频"><a
                                                                href="javascript:void(0);"
                                                                @click="content_msg_tab_nav(4)">&nbsp;<i
                                                                    class="icon_msg_sender"></i><span
                                                    ...
                                                    <li class="tab_nav">
                                                        ...
                                                        <input style="width: 190px" type="text"
                                                               ...
                                                               v-model="menu.button[activeMenuIndex].key" value="">
                                                        <input style="width: 190px" type="text"
                                        ...
                                        <div class="tab_panel">
                                            <div class="tab_content" v-show="showMenuContentMsgType===1"
                                                 style="display: none;">
                                                    ...
                                                    <div class="tab_cont_cover jsMsgSendTab" data-index="0">
                                                        <div class="media_cover">
                                                            <span class="create_access"> <a
                                                                        ...
                                                                        href="javascript:void(0);" data-type="10"
                                                                        data-index="0"> <i
                                                                            class="icon36_common add_gray"></i> <strong>从素材库中选择</strong> </a> </span>
                                                        </div>
                                                        <div class="media_cover">
                 <span class="create_access"> <a target="_blank" class="add_gray_wrp" href="javascript:void(0);"> <i class="icon36_common add_gray"></i> <strong>新建图文消息</strong> </a>
                               ...
                               <a target="_blank" href="javascript:void(0);"><i
                                           class="icon_shopmsg_create multi"></i><strong>多图文消息</strong></a>
                                            ...
                                            <div class="tab_content" v-show="showMenuContentMsgType===2" style="display: none;">
                                                <div class="js_imgArea inner ">
                                                    <!--type 10图文 2图片  3语音 15视频 11商品消息-->
                                                    <div class="tab_cont_cover jsMsgSendTab" data-index="1"
                                                         data-type="2">
                                                        <div class="media_cover">
                                                            <span class="create_access"> <a
                                                                        class="add_gray_wrp jsMsgSenderPopBt"
                                                        ...
                                                        <div class="media_cover">
                                                            <span class="create_access"> <a class="add_gray_wrp"
                                                                            ...
                                                                            class="icon36_common add_gray"></i> <strong>上传图片</strong> </a> </span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab_content" v-show="showMenuContentMsgType===3"
                                                 style="display: none;">
                                                <div class="js_audioArea inner ">
                                                    <!--type 10图文 2图片  3语音 15视频 11商品消息-->
                                                    <div class="tab_cont_cover jsMsgSendTab" data-index="2"
                                                         data-type="3">
                                                        <div class="media_cover">
                                                            <span class="create_access"> <a
                                                                        class="add_gray_wrp jsMsgSenderPopBt"
                                                        ...
                                                        <div class="media_cover">
                                                            <span class="create_access"> <a class="add_gray_wrp "
                                                                                            ...
                                                                                            href="javascript:void(0);"> <i
                                                                            class="icon36_common add_gray"></i> <strong>新建语音</strong> </a> </span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab_content" v-show="showMenuContentMsgType===4"
                                                 style="display: none;">
                                                <div class="js_videoArea inner ">
                                                    ...
                                                    <div class="tab_cont_cover jsMsgSendTab" data-index="3">
                                                        <div class="media_cover">
                                                            <span class="create_access"> <a
                                                                        class="add_gray_wrp jsMsgSenderPopBt"
                                                                        href="javascript:void(0);" data-type="15"
                                                                        data-index="3"> <i
                                                                            class="icon36_common add_gray"></i> <strong>从素材库中选择</strong> </a> </span>
                                                        </div>
                                                        <div class="media_cover">
                                                            <span class="create_access"> <a target="_blank"
                                                                                            class="add_gray_wrp"
                                                                                            href="javascript:void(0);"> <i
                                                                            class="icon36_common add_gray"></i> <strong>新建视频</strong> </a> </span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="menu_content url jsMain" id="url" v-show="showMenuContentType===2"
                                 style="display: none;">
                                <form action="" id="urlForm" onsubmit="return false;">
                                    ...
                                    <div class="frm_control_group">
                                        ...
                                        <div class="frm_controls">
                                            <span class="frm_input_box" v-if="activeMenuType() == 1"> <input type="text"
                                                                                                             class="frm_input"
                                                                                                             id="urlText"
                                                                                                             name="urlText"
                                                                                                             v-model="menu.button[activeMenuIndex].url"/> </span>
                                            <span class="frm_input_box" v-if="activeMenuType() == 2"> <input type="text"
                                                                                                             class="frm_input"
                                                                                                             id="urlText"
                                                                                                             name="urlText"
                                                                                                             v-model="menu.button[activeMenuIndex].sub_button[activeMenuItemIndex].url"/> </span>
                                            <p class="profile_link_msg_global menu_url mini_tips warn dn js_warn">
                                                请勿添加其他公众号的主页链接 </p>
                                            <p class="frm_tips" id="js_urlTitle" style="display: none;"> 来自<span
                                                        class="js_name"></span><span style="display:none;"> -《<span
                                                            class="js_title"></span>》</span></p>
                                        </div>
                                    </div>
                                    <div class="frm_control_group btn_appmsg_wrap">
                                        <div class="frm_controls">
                                            <p class="frm_msg fail dn" id="urlUnSelect" style="display: none;"><span
                                                        for="urlText" class="frm_msg_content" style="display: inline;">请选择一篇文章</span>
                                            </p>
                            ...
                            </div> <div class="menu_content url jsMain" id="url" v-show="showMenuContentType===2"
                                        style="display: none;">
                                <form action="" id="urlForm" onsubmit="return false;">
                                    <p class="menu_content_tips tips_global">订阅者点击该子菜单会跳到以下链接</p>
                                    <div class="frm_control_group">
                            ...
                            <div class="menu_content url jsMain" id="url" v-show="showMenuContentType===3"
                                 style="display: none;">
                                <form action="" id="urlForm" onsubmit="return false;">
                                    <p class="menu_content_tips tips_global">订阅者点击该子菜单会跳到以下链接</p>
                                    <div class="frm_control_group">
                            ...
                            <div class="menu_content sended" style="display:none;">
                                ...
                                <p class="frm_tips">来自<span class="js_name">素材库</span><span
                                            style="display:none;"> -《<span class="js_title"></span>》</span></p>
                            </div>
                            <div id="js_errTips" style="display:none;" class="msg_sender_msg mini_tips warn"></div>
                        </div>
                    </div>
                </div>
                <span class="editor_arrow_wrp"> <i class="editor_arrow editor_arrow_out"></i> <i
                            class="editor_arrow editor_arrow_in"></i> </span>
            </div>
        </div>
    </div>
    <div class="tool_bar tc js_editBox">
        ...
        {{--<a class="btn btn-sm btn-danger sendmunu"><i class="fa fa-bars"></i>生成菜单</a>--}}
...
{{--<script src="{{admin_asset('/wechatAdmin/customMenu/js/vue.js')}}"></script>--}}
{{--<script src="{{admin_asset('/wechatAdmin/customMenu/js/vue-slicksort.min.js')}}"></script>--}}
