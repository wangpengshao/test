                        ...
                        return new Promise(function(resolve) {
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    window.location.href="/admin/share/regionalShare/3";
                                },
                                error:function(){
                                    swal.close();
                                    swal({
...
<div id="app">
    ...
    <section class="content">
        <div class="row"><div class="col-md-12"><div class="box box-info">
                    <form action="/admin/share/regionalShare/3" method="get" accept-charset="UTF-8" class="form-horizontal" pjax-container="">
                        @csrf
                        <div class="box-body">
