...
class LuckyDraw03List extends Model
{

    protected $table = 'wechat_luckydraw_03_list';

    protected $fillable = [
        'rdid', 'text', 'openid', 'is_winning', 'code', 'status', 'token', 'gather_id', 'prize_id', 'l_id',
    ...
    {
        return $this->hasOne(LuckyDrawAddress::class, 'p_id', 'id')->where('draw_type', 3);;
    }
