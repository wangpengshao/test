...
class LuckyDraw03ListController extends Controller
{
    ...
    {
        $grid = new Grid(new LuckyDraw03List);
        $grid->disableExport();
...
//            $actions->disableDelete();
        ...
        $grid->tools(function ($tools) {
            ...
            $tools->append(new BackButton(route('luckyDraw.type03'), '返回活动'));
        });
...
//            '0' => '<span class="badge bg-green">不中奖</span>',
    ...
    {
        $show = new Show(LuckyDraw03List::findOrFail($id));
    ...
    {
        $form = new Form(new LuckyDraw03List);
